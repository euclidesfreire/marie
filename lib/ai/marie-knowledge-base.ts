...
export const marieTreatmentKnowledge: Record<MarieProtocolKey, MarieTreatmentProtocol> = {
  ...
  facial_clareamento: {
    ...
    area: "FACIAL",
    complaintKeywords: ["mancha", "manchas", "melasma", "cloasma", "hpi", "efélides", "melanose solar", "manchas pós-acne", "hipercromia", "clareamento", "pigmentacao", "pigmentação"],
  ...
  facial_olheiras: {
    ...
    area: "FACIAL",
    complaintKeywords: ["olheira", "olheiras", "olheira vascular", "olheira pigmentada", "edema periocular", "regiao dos olhos", "região dos olhos"],
  ...
  facial_outras: {
    ...
    area: "FACIAL",
    complaintKeywords: ["revitalizacao", "revitalização", "pele opaca", "edema facial", "detox facial", "limpeza de pele", "drenagem facial"],
  ...
  corporal_estrias: {
    ...
    area: "BODY",
    complaintKeywords: ["estria", "estrias", "estrias recentes", "estrias antigas", "estrias avermelhadas", "estrias brancas"],
  ...
  corporal_celulite: {
    ...
    area: "BODY",
    complaintKeywords: ["celulite", "celulite edematosa", "celulite fibrosa", "retenção hídrica", "fibro edema", "fibroedema"],
  ...
  corporal_flacidez: {
    ...
    area: "BODY",
    complaintKeywords: ["flacidez corporal", "flacidez pós-emagrecimento", "tonificacao", "tonificação", "firmeza corporal"],
  ...
  corporal_clareamento: {
    ...
    area: "BODY",
    complaintKeywords: ["clareamento corporal", "clareamento de axila", "clareamento de virilha", "axila", "virilha", "area intima", "área íntima", "interno de coxa", "coxa", "gluteos", "glúteos", "joelho", "cotovelo"],
  ...
  corporal_relaxamento: {
    ...
    area: "BODY",
    complaintKeywords: ["relaxamento", "tensão muscular", "retenção hídrica", "massagem", "drenagem", "detox", "spa dos pés", "spa dos pes", "ventosa", "pedras quentes"],
